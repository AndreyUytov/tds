...
function vanillaSelectBox(domSelector, options) {
  ...
  this.getCssArray = function (selector) {
    ...
    if (selector === '.vsb-main button') {
      cssArray = [
        ...
        { key: 'z-index', value: '1' },
        { key: 'color', value: '#fff' },
        { key: 'background', value: 'transparent !important' },
        { key: 'border', value: '1px solid #7d8e9d !important' },
        { key: 'line-height', value: '26px' },
        { key: 'font-size', value: '18px' },
        { key: 'padding', value: '12px 30px 12px 20px' },
      ]
    }
  ...
  this.init = function () {
    ...
    caret.style.right = '24px'
    caret.style.marginTop = '12px'
    ...
    Array.prototype.slice.call(this.options).forEach(function (x) {
      ...
      let markerCheckbox = document.createElement('span')
      markerCheckbox.classList.add('filters-form__checkbox-marker')
      ...
      checkbox.innerHTML = `<use href="#admin-check" />`
      markerCheckbox.append(checkbox)
      li.append(markerCheckbox)
